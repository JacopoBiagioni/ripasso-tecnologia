...
export class AppComponent implements OnInit {
  ...
  url : 'https://5000-jacopobiagi-ripassotecn-9grmi4limpj.ws-eu97.gitpod.io/prova';
  ...
  //  }
  //  })
  this.http.get<Prova[]>("https://5000-jacopobiagi-ripassotecn-9grmi4limpj.ws-eu97.gitpod.io/prova").subscribe(data =>{
     for (let d of data) {
      let lng = d[0]
      let lat = d[1]
